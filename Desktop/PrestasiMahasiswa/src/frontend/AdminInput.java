...
public class AdminInput extends javax.swing.JFrame {
    ...
    public AdminInput(String nama,String username, String password) {
        initComponents();
    ...
    private void ButtonSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonSimpanActionPerformed
        if (txtNama.getText().equals("") || txtUsername.getText().equals("") || txtPassword.getText().equals("")) {
            ...
            if (JOptionPane.showConfirmDialog(rootPane, "Anda Yakin Ingin menyimpan?") == 0) {
                ...
                Admin adm = new Admin();
                adm.setNAMA_ADMIN(txtNama.getText());
                adm.setUSERNAME(txtUsername.getText());
                adm.setPASSWORD_ADMIN(txtPassword.getText());
                adm.save();
